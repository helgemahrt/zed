    ...
    Theme {
        ...
        styles: ThemeStyles {
            ...
            colors: ThemeColors {
                ...
                vim_mode_indicator_normal_text: hsla(221. / 360., 11. / 100., 86. / 100., 1.0),
                vim_mode_indicator_normal_background: bg,
                vim_mode_indicator_insert_text: hsla(221. / 360., 11. / 100., 86. / 100., 1.0),
                vim_mode_indicator_insert_background: bg,
                vim_mode_indicator_visual_text: hsla(221. / 360., 11. / 100., 86. / 100., 1.0),
                vim_mode_indicator_visual_background: bg,
                vim_mode_indicator_replace_text: hsla(221. / 360., 11. / 100., 86. / 100., 1.0),
                vim_mode_indicator_replace_background: bg,
            },
            status: StatusColors {
                conflict: yellow,
